...
static void write_header(FILE *fp, char *inf, int pfl)
   {char s[BFLRG];
    ...
    fprintf(fp, "/*\n");
    fprintf(fp, " * %s.H - type handling routines\n", p);
    fprintf(fp, " *  NOTE: this file was automatically generated by template\n");
    fprintf(fp, " *  any manual changes will not be effective\n");
    fprintf(fp, " *\n");
    fprintf(fp, " */\n");
    fprintf(fp, "\n");
