...
/* TCGETATTR - tcgetattr for MSW */

int tcgetattr(int fd, struct termios *trm)
   {int rv;
...
/* TCSETATTR - tcsetattr for MSW */

int tcsetattr(int fd, int act, const struct termios *trm)
   {int rv;
