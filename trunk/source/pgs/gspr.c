...
/* define '+' marker */
    ...
    PG_def_marker(2, x1[0], x1[1], x2[0], x2[1]);
...
/* define '*' marker */
    ...
    PG_def_marker(4, x1[0], x1[1], x2[0], x2[1]);
...
/* define triangle marker */
    ...
    PG_def_marker(3, x1[0], x1[1], x2[0], x2[1]);
...
/* define circle marker */
    ...
    PG_def_marker(16, x1[0], x1[1], x2[0], x2[1]);
...
int PG_def_marker(int n, double *xa, double *ya, double *xb, double *yb)
   {int ne, nm;
    PG_marker *mrk;
