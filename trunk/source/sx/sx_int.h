...
extern object
 *_SX_mh_u_s(PFVoid f, object *argl),
 *_SX_mh_u_s_nm(PFVoid oper, object *argl),
 *_SX_m11_x(PFVoid oper, object *argl),
 *_SX_m11_b_mds(PFVoid oper, object *argl),
 *_SX_m11_b_mro(PFVoid oper, object *argl),
 *_SX_m11_b_mrs(PFVoid oper, object *argl),
 *_SX_mh_u_m(PFVoid oper, object *argl),
 *_SX_mh_u_o(PFVoid oper, object *argl),
 *_SX_mh_u_v(PFVoid oper, object *argl),
 *_SX_ah_m(PFVoid oper, object *argl);


/* SXHBO.C declarations */

extern object
 *_SX_mh_b_s(PFVoid fn, object *argl);
