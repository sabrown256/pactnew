...
/*
        SC_hasharr_install(swtab, "physical",   &plot_physical, SC_INTEGER_S, TRUE, TRUE);
        SC_hasharr_install(swtab, "logical",    &plot_log,      SC_INTEGER_S, TRUE, TRUE);
*/
        SC_hasharr_install(swtab, "mesh-r",     &mesh_mesh_r,   SC_INTEGER_S, TRUE, TRUE);
        SC_hasharr_install(swtab, "boundary-r", &mesh_bndry_r,  SC_INTEGER_S, TRUE, TRUE);
        SC_hasharr_install(swtab, "vector-r",   &mesh_vectr_r,  SC_INTEGER_S, TRUE, TRUE);};
