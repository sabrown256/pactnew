/*
 * TGSIM.C - test the image drawing routines in PGS
 *
 * Source Version: 3.0
...
static void print_help(void)
   {
    ...
    PRINT(STDOUT, "\nTGSIM - test the image plotting in PGS\n");
    PRINT(STDOUT, "\n");

    PRINT(STDOUT, "Usage: tgsim [-h] [-p] [-z #]\n");
    PRINT(STDOUT, "\n");
...
int main(int argc, char **argv)
   {int i, k, l;
    ...
    PS_cdev  = PG_make_device("PS", "COLOR", "tgsim-c");
    CGM_cdev = PG_make_device("CGM", "COLOR", "tgsim-c");
    PS_mdev  = PG_make_device("PS", "MONOCHROME", "tgsim-m");
    CGM_mdev = PG_make_device("CGM", "MONOCHROME", "tgsim-m");
