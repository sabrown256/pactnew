...
struct s_PG_graph
   {PM_mapping *f;
    ...
    int mesh;
    const char *info_type;                 /* data type for the info member */
    void *info;        /* attribute information for the rendering algorithm */
    int identifier;
    const char *use;                    /* volatile communicator internally */
...
typedef int (*PFOpenConsole)(const char *title, const char *type, int bckgr,
...
/* 16 standard colors */
    ...
    int (*set_font)(PG_device *dev, const char *face,
    ...
    void (*write_text)(PG_device *dev, FILE *fp, const char *s);
 ...
 *PG_make_interface_object_n(PG_device *dev,
...
extern PG_graph
 *PG_make_graph_1d(int id, const char *label, int cp,
