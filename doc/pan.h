...
TRUE is returned if the call is successful; otherwise, FALSE is returned and any error message can be obtained by calling PD_get_error().<p>
...
TRUE is returned if the call is successful; otherwise, FALSE is returned and the ASCII string PD_get_error() contains any error message that was generated.<p>
...
A pointer to the type&#146;s defstr is returned if the call is successful; otherwise, NULL is returned and the ASCII string PD_get_error() contains any error message that was generated.<p>
...
the ASCII string PD_get_error() contains any error message that was generated.<p>
...
and the ASCII string PD_get_error() contains any error message that was generated.<p>
